...
class Item(models.Model):
    ...
    description_short = models.CharField(max_length=512, verbose_name=u'краткое описание')
    ...
    is_novelty = models.BooleanField(blank=True, default=False, verbose_name=u'это новинка')
