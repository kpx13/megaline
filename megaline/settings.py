...
DATABASES = {
    'default': {
        ...
        'NAME': 'megaline',   # Or path to database file if using sqlite3.
        'USER': 'megaline',                      # Not used with sqlite3.
        'PASSWORD': 'megaline',                  # Not used with sqlite3.
